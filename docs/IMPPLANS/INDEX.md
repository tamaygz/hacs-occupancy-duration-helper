...
| [feature-entities-persistence-and-observability-1.md](./feature-entities-persistence-and-observability-1.md) | Entities, coordinator wiring, restore, diagnostics, HA events, unload behavior | Completed | 12 | 0 | Implemented lifecycle setup/unload in `__init__.py`, push-style runtime coordinator, Home Assistant storage-backed session persistence, sensor/binary_sensor entities, diagnostics export, event emission, and helper-contract tests for sensors and restore; compile and diagnostics passed | Session/decay plan; config flow plan |
...
| [process-quality-validation-and-release-1.md](./process-quality-validation-and-release-1.md) | Tests, CI, issue templates, validation gates, release workflow, HACS readiness | Completed | 13 | 0 | Added shared pytest fixtures, validation workflow, automated `release.yml`, both issue templates, version-sync enforcement, and a documented release gate in README; YAML and compile validation passed | All other plans |
